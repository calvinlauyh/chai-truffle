...
declare interface TestContractInstance extends Truffle.ContractInstance {
  ...
  emitDefaultMessageAndTestEvents: Truffle.ContractFunction<() => Promise<void>>;
  emitDefaultMessageEvent: Truffle.ContractFunction<() => Promise<void>>;
  emitTwoMessageEvents: Truffle.ContractFunction<(firstMessage: string, secondMessage: string) => Promise<void>>;
  emitMessageEvent: Truffle.ContractFunction<(message: string) => Promise<void>>;
